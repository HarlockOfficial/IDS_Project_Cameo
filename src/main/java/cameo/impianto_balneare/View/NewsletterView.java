...
public class NewsletterView {
    ...
    public ResponseEntity<Newsletter> addNewsletter(@RequestBody Newsletter newsletter, @RequestHeader("token") String token) {
    ...
    public ResponseEntity<Newsletter> editNewsletter(@RequestBody Newsletter newsletter, @RequestHeader("token") String token) {
    ...
    public ResponseEntity<Newsletter> deleteNewsletter(@PathVariable UUID id, @RequestHeader("token") String token) {
